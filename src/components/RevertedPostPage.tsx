...
export default function RevertedPostPage({ 
  ...
  const revertedArticles = [
    {
      ...
      reason: 'Factual inconsistencies found in paragraph 3. Sources need verification.',
      editor: 'John Smith'
    },
    {
      id: 2,
  ...
  const renderGridView = () => (
    <div className="grid grid-cols-3 gap-6">
      {filteredArticles.map((article) => (
        <Card key={article.id} className="p-4 bg-white border-red-200 hover:shadow-md transition-shadow">
          <div className="space-y-3">
            ...
            <div className="p-3 bg-red-50 border border-red-200 rounded-md">
              <div className="text-xs font-medium text-red-800 mb-1">Revision Required</div>
  ...
  const renderListView = () => (
    <div className="space-y-3">
      {filteredArticles.map((article) => (
        <Card key={article.id} className="p-4 bg-white border-red-200 hover:shadow-sm transition-shadow">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs text-gray-500">
                      Reverted {article.lastUpdated} • {article.wordCount} words • Editor: {article.editor}
                    </span>
                  </div>
                </div>
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="flex-1 p-4">
          <div className="space-y-1">
            ...
            <Button variant="default" size="sm" className="w-full justify-start gap-2 bg-red-600 hover:bg-red-700">
              <RotateCcw className="w-4 h-4" />
              Reverted Post
              <span className="ml-auto bg-white text-red-600 text-xs px-1.5 py-0.5 rounded-full">
                {revertedArticles.length}
              </span>
            </Button>
            <Button 
              variant="ghost" 
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              <Button variant="ghost" size="sm" className="w-full justify-start gap-2 bg-red-50 text-red-600 hover:bg-red-100">
                <RotateCcw className="w-4 h-4" />
                Reverted Post
              </Button>
              <Button 
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Articles that need revision and resubmission</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
