...
export default function HistoryLogPage({ 
  ...
  const statusOptions = ['All Status', 'Approved', 'Submitted', 'Reverted', 'Draft'];
  ...
  const filteredArticles = historyArticles.filter(article => {
    ...
    const matchesStatus = statusFilter === 'All Status' || article.status === statusFilter;
    const matchesType = typeFilter === 'All Type' || article.type === typeFilter;
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="flex-1 p-4">
          <div className="space-y-1">
            ...
            <Button variant="default" size="sm" className="w-full justify-start gap-2 bg-blue-600 hover:bg-blue-700">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Track all article activities and changes</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="bg-white">
            ...
            <div className="divide-y divide-gray-200">
              {filteredArticles.map((article) => (
                <div key={article.id} className="grid grid-cols-12 gap-4 p-6 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="col-span-2">
                    <div className="text-sm text-gray-900">{article.reporter}</div>
                  </div>
