...
export function SocialMediaPublishCard({ 
  ...
  const [platforms, setPlatforms] = useState<PublishPlatform[]>([
    ...
    { id: "web", name: "Web", icon: <Globe className="w-4 h-4" />, checked: false },
    { id: "instagram", name: "Instagram", icon: <Instagram className="w-4 h-4" />, checked: false },
    { id: "facebook", name: "Facebook", icon: <Facebook className="w-4 h-4" />, checked: false },
    { id: "twitter", name: "Twitter", icon: <Twitter className="w-4 h-4" />, checked: false },
  ]);
